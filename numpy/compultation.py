...
x = np.arange(1, 6) # 1 2 3 4 5 = 15
# print(np.add.reduce(x))
# print(sum(x))
# print(np.sum(x))
#
# Tính tích các phần tử trong mảng
# print(np.multiply.reduce(x)) # 5! = 120
#
# print(np.add.accumulate(x))
# print(np.multiply.accumulate(x))
#
# # # Phép nhân hai ma trận
x = np.random.randint(1, 5, (1, 6))
# y = np.arange(1, 100)
# print(np.multiply.outer(x, y).shape)  # Phân tử thứ 2 là ma trận chuyển vị
# print(np.dot(x.T, x))
# print(x)
# Min, Max
